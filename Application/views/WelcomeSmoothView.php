    ...
    <div class="container-narrow">
      ...
      <div class="masthead">
        <ul class="nav nav-pills pull-right">
          <li class="active"><a href="<?php echo WEBPATH . 'Docs/index.html'; ?>">Documentation</a></li>
        </ul>
        <h3 class="muted">Smooth Php Framework</h3>
      </div>
...
<!-- 
      ...
      <div class="footer">
        <p>&copy; Smoothphp framework by <a href="#">Konstantin Rachev</a></p>
      </div>
 -->
    </div>
